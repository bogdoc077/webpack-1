...
/*
 Отлично:
 - Реализовано дополнительное задание - добавление карточек.
 Надо исправить:
 - СДЕЛАНО! Редактирование профиля закрывается, даже если запрос не выполнился //теперь вроде бы все верно)
 Можно лучше:
 - Убрать функции обработчики по нужным классам.
*/